...
#include "vdb_gpdf_msgs/SaveMap.h"
#include "vdb_gpdf_msgs/SliceQueryMap.h"
#include "vdb_gpdf_msgs/PointsQueryMap.h"
...
class VDBGPDFMapper {
 public:
  ...
  bool saveMap_callback(vdb_gpdf_msgs::SaveMap::Request &req,
                        vdb_gpdf_msgs::SaveMap::Response &res);

  bool pointsQueryMap_callback(vdb_gpdf_msgs::PointsQueryMap::Request &reqQ,
                               vdb_gpdf_msgs::PointsQueryMap::Response &resS);
  bool sliceQueryMap_callback(vdb_gpdf_msgs::SliceQueryMap::Request &reqQ,
                              vdb_gpdf_msgs::SliceQueryMap::Response &resS);

  void savePosesToCSV(const std::string& filename);
 ...
 private:
  ...
  std::vector<std::pair<int, Eigen::Matrix4d>> saved_poses_;
};
}  // namespace vdb_gpdf_mapper
